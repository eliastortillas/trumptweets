...
2. When are people Googling some terms related to the 2016 election? These are pulled from Google Trends. 
...
3. What emotions is Trump using in his tweets?
...
```
4. How does Trumps approval change over time?
